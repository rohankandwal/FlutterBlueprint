...
import 'package:flutter_blueprint_example/src/screens/check_boxes_screen/check_boxes_screen.dart';
...
const _kDesignSystemCategories = [
  ...
  DesignSystemCategoryCard(title: 'CheckBoxes', child: CheckBoxesScreen()),
];
