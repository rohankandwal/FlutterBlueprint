...
Color resolveNormalMaterialState({
  required Set<MaterialState> states,
  required FlutterBluePrintThemeExtension theme,
}) {
  if (states.contains(MaterialState.disabled)) {
    return theme.colors.neutral.neutral50;
  } else if (states.contains(MaterialState.pressed)) {
    return theme.colors.interaction.pressed;
  } else if (states.contains(MaterialState.hovered)) {
    return theme.colors.interaction.hover;
  }
